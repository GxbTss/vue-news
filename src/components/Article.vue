	...
	<div>
        ...
        <div class="content">
            ...
            <div class="cont">
		        ...
		        <div class="time"><p>{{articleData.time | timer}} <span><img src="../assets/img/zan.png" alt=""/></span></p></div>
...
<script>
	export default{
        ...
        methods:{
            fetch(id){
                var _this = this;
                this.$http.get('../src/data/article.data').then(function(msg){
                    _this.articleData=msg.data[id];
